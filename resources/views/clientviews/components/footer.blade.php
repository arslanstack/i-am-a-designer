            ...
            <div class="col-lg-8 col-12">
                <div>
                    <ul class="d-flex list-unstyled footer-links flex-wrap footer-middle">
                        ...
                        <li>
                            <a href="{{route('about')}}" class="text-black text-decoration-none fw-semibold">About</a>
                        </li>
                        <li>
                            <a href="{{route('contact')}}" class="text-black text-decoration-none fw-semibold">Contact Us</a>
                        </li>
                    </ul>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-lg-6 col-12">
                <div class="lower-links text-lg-start text-center">
                    ...
                    <a href="{{route('privacy')}}" class="mx-2 text-decoration-none">Privacy Policy</a>
                </div>
            </div>
            <div class="col-lg-6 col-12">
                <div class="lower-links text-lg-end text-center">
                    <a href="https://arslanstack.com" class="mx-2 text-decoration-none">Get A Website</a>
                    <a href="{{route('welcome')}}" class="mx-2 text-decoration-none">Sitemap</a>
                </div>
            </div>
        </div>
    </div>
...
<footer class="">
    <div class="container">
        <div class="row pb-2 pt-2">
            ...
            <div class="col-lg-8 col-12">
                <div>
                    <ul class="d-flex list-unstyled footer-links flex-wrap footer-middle mt-lg-4 m-0 justify-content-center">
                        <li>
                            <a href="#" class="text-black text-decoration-none fw-semibold">For Designers</a>
                        </li>
                        <li>
                        ...
                        <li>
                            <a href="#" class="text-black text-decoration-none fw-semibold">About Us</a>
                        </li>
                        <li>
    ...
    <div class="container py-4" style="border-top: 1px solid rgb(221, 218, 218);">
        <div class="row">
            <div class="col-lg-6 col-12">
                <div class="lower-links text-lg-start text-center">
                    <span>© 2024 The Dribbble Company</span>

                </div>
            </div>
            <div class="col-lg-6 col-12">
                <div class="lower-links text-lg-end text-center">
                    <a href="#" class="mx-2 text-decoration-none">Terms & Condition</a>
