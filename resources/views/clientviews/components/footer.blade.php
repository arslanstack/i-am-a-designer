            ...
            <div class="col-lg-8 col-12">
                <div>
                    <ul class="d-flex list-unstyled footer-links flex-wrap footer-middle mt-lg-4 m-0 justify-content-center">
                        <li>
                            <a href="{{route('designer.dashboard')}}" class="text-black text-decoration-none fw-semibold">For Designers</a>
                        </li>
                        <li>
                            <a href="{{route('designers')}}" class="text-black text-decoration-none fw-semibold">Hire Talent</a>
                        </li>
                        <li>
                            <a href="{{route('about')}}" class="text-black text-decoration-none fw-semibold">About Us</a>
                        </li>
                        <li>
