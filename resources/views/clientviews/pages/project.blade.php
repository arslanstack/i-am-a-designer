...
<div class="container mt-3">
    ...
    <ul class="nav nav-tabs justify-content-center border-0" id="myTab" role="tablist">
        <li class="nav-item" role="presentation">
            <a class="nav-link active border-0 text-black" href="/designer-profile/{{$designer->username}}?tab=work" style="text-decoration: none; color: black;">
                Work
            </a>
        </li>
        <li class="nav-item" role="presentation">
            <a class="nav-link" id="profile-tab border-0 text-black" href="/designer-profile/{{$designer->username}}?tab=resume" style="text-decoration: none; color: black;">
                Resume
            </a>
        </li>

        <li class="nav-item" role="presentation">
            <a class="nav-link" id="contact-tab border-0 text-black" href="/designer-profile/{{$designer->username}}?tab=about" style="text-decoration: none; color: black;">
                About Me
            </a>
        </li>
    </ul>
...
<div class="container">
    ...
    <div class="col-lg-8 mx-auto pt-3 pb-5">
        ...
        <video id="my-video" class="video-js mb-2" controls preload="auto" data-setup='' loop>
            <source src="{{asset('uploads/projects/' . $video)}}" type='video/mp4'>
        </video>
        @endforeach
        @foreach($images as $image)
        <div class="my-2">

            <img class="toZoom" src="{{asset('uploads/projects/' . $image)}}" width="100%" />
