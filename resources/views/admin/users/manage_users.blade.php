                            ...
                            <tbody>
                                ...
                                <tr class="gradeX">
                                    ...
                                    <td>
                                        ...
                                        @if ($item->status==1)
                                        <button class="btn btn-danger btn-sm btn_update_status" data-id="{{$item->id}}" data-status="0" data-text="You want to deactivate this user!" type="button" data-placement="top" title="Inactivate">Deactivate</button>
                                        @else
                                        <button class="btn btn-success btn-sm btn_update_status" data-id="{{$item->id}}" data-status="1" data-text="You want to activate this user!" type="button" data-placement="top" title="Activate">Activate</button>
                                        @endif
                                    </td>
                                </tr>
                                @endforeach
