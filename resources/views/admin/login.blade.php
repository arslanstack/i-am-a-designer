...
<head>
	...
	<link rel="shortcut icon" href="{{ asset('clientSideAssets/images/favicon.ico') }}" type="image/x-icon">
</head>
	...
	<div class="middle-box text-center loginscreen animated fadeInDown">
		<div>
			<div class="col-lg-12 text-center mb-4" style="margin-top: 70px;">
				...
				<img class="img-responsive" src="{{ asset('clientSideAssets/images/logo.png') }}" alt="logo" style="width: 241px;">
			</div>
