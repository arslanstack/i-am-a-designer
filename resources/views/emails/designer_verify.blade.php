...
<head>
    ...
    <title>Please Verify Your Email Address to Continue Using Our Platform</title>
</head>
...
<body>
    ...
    <div style="background-color: #f4f4f4; padding: 20px;">
        <div style="background-color: #fff; padding: 20px; border-radius: 10px;">
            ...
            <a href="{{ $verification_url }}" style="display: block; width: 100%; padding: 10px; background-color: #007bff; color: #fff; text-align: center; text-decoration: none; border-radius: 5px;">Verify Email Address</a>
