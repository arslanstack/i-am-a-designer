                    ...
                    <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-12">
                                    <div class="mb-3">
                                        ...
                                        <img src="{{asset('clientSideAssets/images/image-blank.png')}}" id="bannerPreview" class="img-fluid" alt="preview" style="height: auto; width: 480px; overflow:auto;">
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-12">
                            <div class="mb-3 pb-2">
                                ...
                                <textarea class="form-control" id="content" name="description" placeholder="Enter the Description" rows="10"></textarea>
                            </div>
                        </div>
                        <!--end col-->
