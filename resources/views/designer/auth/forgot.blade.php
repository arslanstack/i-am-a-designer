    ...
    <div class="col-lg-7 mx-auto card border-0" style="box-shadow: rgba(100, 100, 111, 0.2) 0px 7px 29px 0px;border-radius:30px;overflow:hidden">
        <div class=" d-md-flex align-items-center justify-content-between">
            ...
            <div class=" box-2 d-flex flex-column">
                <div class="mt-3 mx-3">
                    <p class="mb-1 h-1 text-center">Forgot Password?</p>
                    <p class="text-muted mb-4 text-center">Enter your email address to receive a reset link.</p>
                    @if(session('error'))
                    ...
                    <div class="d-flex flex-column ">
                        <form method="post" action="{{route('designer.resetMail')}}">
                            @csrf
                            ...
                            <div class="text-center py-3">
                                <small class="text-muted">
                                    <a href="{{route('designer.register')}}" class="text-muted">Login to your account?</a></small>
                            </div>
                        </form>
                    </div>
                </div>
