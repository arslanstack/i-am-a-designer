    ...
    <div class="col-lg-7 mx-auto card border-0" style="box-shadow: rgba(100, 100, 111, 0.2) 0px 7px 29px 0px;border-radius:30px;overflow:hidden">
        <div class=" d-md-flex align-items-center justify-content-between">
            ...
            <div class=" box-2 d-flex flex-column">
                <div class="mt-3 mx-3">
                    <p class="mb-1 h-1 text-center">Reset Password</p>
                    <p class="text-muted mb-4 text-center">Enter new password.</p>
                    @if(session('error'))
                    ...
                    <div class="d-flex flex-column ">
                        <form method="post" action="{{route('designer.resetPassword')}}">
                            @csrf
                            <input type="text" name="token" value="{{$token}}" hidden>
                            <div class="form-floating mb-3">
                                <input type="password" name="password" required class="form-control" id="floatingInput" placeholder="" />
                                <label for="floatingInput">Password</label>
                            </div>
                            <div class="form-floating mb-3">
                                <input type="password" name="password_confirmation" required class="form-control" id="floatingInput" placeholder="" />
