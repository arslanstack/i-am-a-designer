            ...
            <div class="dropdown ms-sm-3 header-item topbar-user">
                <button type="button" class="btn" id="page-header-user-dropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <span class="d-flex align-items-center">
                        <img class="rounded-circle header-profile-user" src="{{Auth::guard('designer')->user()->image != 'avatar.png' ? asset('uploads/designers/images/' . Auth::guard('designer')->user()->image ) : asset('clientSideAssets/images/avatar.png')}}" alt="Header Avatar">
                        <span class="text-start ms-xl-2">
                            <span class="d-none d-xl-inline-block ms-1 fw-medium user-name-text">{{Auth::guard('designer')->user()->name}}</span>
